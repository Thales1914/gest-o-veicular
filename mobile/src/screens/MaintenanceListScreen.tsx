...
import { summarizeMaintenanceHistory } from '../utils/maintenanceCalculations';
...
export function MaintenanceListScreen({ route, navigation }: Props) {
  ...
  const summary = useMemo(() => summarizeMaintenanceHistory(records), [records]);
          ...
          ListHeaderComponent={sortedRecords.length ? (
            <View style={styles.summaryCard}>
              ...
              <View style={styles.summaryGrid}>
                ...
                <View style={styles.summaryItem}>
                  <Text style={styles.summaryLabel}>Última manutenção</Text>
                  <Text style={styles.summaryValue}>
                    {summary.lastServiceDate ? formatDateBR(summary.lastServiceDate) : '—'}
                  </Text>
                </View>
              </View>
            </View>
